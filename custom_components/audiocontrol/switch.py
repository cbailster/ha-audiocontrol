"""Switch platform for AudioControl integration."""
...
class PowerSwitch(CoordinatorEntity[AudioControlCoordinator], SwitchEntity): # pyright: ignore[reportIncompatibleVariableOverride] pylint: disable=abstract-method
    ...
    def __init__(self, coordinator: AudioControlCoordinator, entry: ConfigEntry) -> None:
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        """Turn on power."""
        await self._coordinator.config_entry.runtime_data.client.amp_power(True)
        self._coordinator.async_update_from_client()

    async def async_turn_off(self, **kwargs: Any) -> None:
        """Turn off power."""
        await self._coordinator.config_entry.runtime_data.client.amp_power(False)
        self._coordinator.async_update_from_client()